...
#str(table1_all)
table1_all[25,(2:15)] <- colSums(table1_all[,2:15], na.rm=TRUE)
table1_all[25,1] <- "Total"
...
# clone pgp_master_couts for merge with matrix
